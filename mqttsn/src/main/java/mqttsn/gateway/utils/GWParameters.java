...
public class GWParameters {
    ...
    public static int getMaxMqttSNLength() {
        return maxMqttsLength;
    }

    public static void setMaxMqttSNLength(int maxMqttsLength) {
        GWParameters.maxMqttsLength = maxMqttsLength;
    }

    public static int getMinMqttSNLength() {
        return minMqttsLength;
    }

    public static void setMinMqttSNLength(int minMqttsLength) {
